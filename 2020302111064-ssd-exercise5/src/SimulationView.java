...
public class SimulationView {
    ...
    public static String getHtml(Simulation sim) {
        ...
        HtmlImage blankImage = new HtmlImage("resource/blank.gif", "Maybe algae. No other life.");
        ...
        for(beingIndex = 0; beingIndex < beings.size(); ++beingIndex) {
           ...
           // System.out.println(being.getName()+"column"+being.getColumn());
            //System.out.println(being.getName()+"row"+being.getRow());
        }
